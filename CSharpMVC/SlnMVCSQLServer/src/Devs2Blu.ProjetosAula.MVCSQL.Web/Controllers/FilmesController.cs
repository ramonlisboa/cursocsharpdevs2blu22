...
namespace Devs2Blu.ProjetosAula.MVCSQL.Web.Controllers
{
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] Filme filme)
        {
            if (id != filme.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Contexto.Filme'  is null.");
            }
            var filme = await _context.Filme.FindAsync(id);
            if (filme != null)
            {
